public class Move {
    ...
    public Move (String move){
        move = move.trim();
        this.horizontalStart = getXNumberFromLetter(move.charAt(0));
        this.verticalStart = Character.getNumericValue(move.charAt(1));
        this.horizontalDestination = getXNumberFromLetter(move.charAt(5));
        this.verticalDestination = Character.getNumericValue(move.charAt(6));
    }
